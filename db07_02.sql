...
(7, 'aa', 6, 0),
(8, 'bb', 6, 0),
(9, '問題一：你最常做什麼運動來促進健康體能呢?', 0, 0),
(10, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 9, 0),
(11, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 9, 0),
(12, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 9, 0),
(13, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 9, 0),
